...
//-----------------------------------------------------------------------------
 ...
 class Pila {
	...
	public:
	        ...
	        Pila(const Tipo &dato_a_agregar, std::size_t cantidad_total);
...
template <class Tipo> 
ayed_cont::Pila<Tipo>::Pila(const Tipo &dato_a_agregar, std::size_t cantidad_total) {
...
template <class Tipo>
void ayed_cont::Pila<Tipo>::push(const Tipo &dato_a_agregar) {
